...
-   column graph of ANPP (total plot-level); factors = treatment and site

-   column graph of total root biomass; factors = treatment and site

-   column graph of root:ANPP; factors = treatment and site
...
#  scale_y_continuous(limits = c(0, 6), breaks = c(0, 2, 4, 6)) +
  labs(x = "Site", 
       y = "Mean Plot ANPP (units?)") +  # need to double check Seth's units
